...
export class WorkspaceRuntime implements IWorkspaces {
  ...
  /**
   * Permanently delete a session: host removes the persisted log and every
   * registry reference; the local list projection drops the row via the
   * host/session-removed frame and the workspace sessionIds echo.
