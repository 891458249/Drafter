...
const OWNER = '891458249', REPO = 'Drafter', TAG = 'v0.13.8';
const DIST = 'D:\\ClaudeUI\\dist';
const ASSETS = [
  { local: 'Drafter Setup 0.13.8.exe', remote: 'Drafter-Setup-0.13.8.exe' },
  { local: 'Drafter Setup 0.13.8.exe.blockmap', remote: 'Drafter-Setup-0.13.8.exe.blockmap' },
...
(async () => {
  ...
  const notes = [
    '### v0.13.8(2026-09-04):画布节点汉化(i18n)+ 微缩视口 LOD 骨架渲染', '',
