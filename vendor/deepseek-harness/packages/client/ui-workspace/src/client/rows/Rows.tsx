 ...
 * @param props.onDelete - open the permanent-delete confirmation for a session by id.
...
export function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onDelete, drag, flat = false, t }: {
  ...
  /** Open the browser-owned permanent-delete dialog (row menu action). */
  ...
  const sessionMenuItems = [
    ...
    { id: 'delete', label: t('menu.deleteSession'), icon: <IconTrashOutline16 size={16} />, danger: true },
  ]
