...
const checks = [
  ['main.js', ['resolveBoard', "['media', 'image', 'video', 'audio', 'model']", 's.meta.board', 'aigc:exec', 'canvas:saveUpload', 'assets:list']],
  ['src\\main\\migrations.js', ['mediaBoardStamped', "kind: 'media', board: m.kind", 'repairMediaBoard']],
  ['src\\main\\aigc.js', ['resolveBoard']],
  ['src\\main\\canvases.js', ['patchTask', 'listAssets', 'saveUpload']],
  ...
  ['src\\renderer\\canvas.js', ['Drawflow', 'aigcExec', 'nodeData', 'runNode']],
