...
const OWNER = '891458249', REPO = 'Drafter', TAG = 'v0.9.20';
const DIST = 'D:\\ClaudeUI\\dist';
const ASSETS = [
  'DeskTopUI Setup 0.9.20.exe',
  'DeskTopUI Setup 0.9.20.exe.blockmap',
  'latest.yml',
];
...
(async () => {
  ...
  const notes = [
    ...
    '',
    '- 消息缩略导航各项间距加大(10px),横杠加粗(6px),悬停展开/点击不再挤在一起误触',
    '',
  ...
  try {
    ...
    rel = await api('POST', `/repos/${OWNER}/${REPO}/releases`, { tag_name: TAG, name: 'DeskTopUI v0.9.20', body: notes, draft: false, prerelease: false });
